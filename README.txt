...
-pentru a putea citi textul am folosit un vector temporar cu ajutorul caruia am alocat pe rand fiecarei linii cata
memorie este necesara
...
-cu ajutorul unui vector temporar aloc eficient memoria: pentru sirul de delimitatori, pentru vectorul de indici,
pentru textul citit, eliminand sfarsitul de linie
-pentru sortarea sirului de indici am folosit algoritmul bubble sort
-am eliminat valorile identice
-am parcurs textul si am selectat fiecare cuvant in parte, am testat daca cuvantul este in vectorul de indici, iar cu
ajutorul vectorului temporar am construit noul text
-prelucrez sirurile si eliberez memoria

Cerinta 3: functia sort
-am declarat un struct pentru a inregistra eficient materiile
-in functia read_situatie am citit datele pentru situatie-student:citire numar materii, note pentru fiecare materie;
am alocat si am realocat memorie pentru fiecare linie, incrementand cu o dimensiune maxima de 3 si am calculat media notelor
...
suplimentare
-am parcurs fiecare linie cu un contor la inceput si unul la sfarsit, am verificat daca cuvantul este numar,iar daca nu
 se indeplinea conditia se codifica cuvantul
-am eliberat memoria
